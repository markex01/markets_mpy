...
class AuroraHttpClient:
    ...
    def describe_available_forecasts(self) -> dict:
        """Fetches the list of available forecast scenarios from the Aurora API.

        Returns:
            dict: Parsed JSON payload containing lists of scenarios, currencies,
                and regions. Returns an empty dict if the request fails.
        """
